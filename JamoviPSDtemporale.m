function matrix=JamoviPSDtemporale(chan,PSDepochFNSZ,PSDepochGNSZ)
chan=17;%19 canali
...
outDirchan='C:\Users\gioiachiodi\Documents\MATLAB\PSDtemporale\';
...
save(strcat(filenamechan,'PSDtemporale'),'matrix')
